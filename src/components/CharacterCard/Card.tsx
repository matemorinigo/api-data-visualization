...
const Card = (props: { char: Character, innerRef?: ((node: HTMLElement | null) => void) | undefined, className?: string }) => {
  ...
  return (
    ...
    }} className={`m-2 relative w-60 min-h-[10rem] h-max-[12rem] bg-gradient-to-br from-slate-400 to-slate-700 border-black shadow-xl rounded-2xl gap-4 p-4 flex flex-col m-0 items-center ${props.className ? props.className : ''} `} onMouseMove={handleMouseMove}>
      <div style={{
